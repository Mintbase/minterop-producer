...
import { ACCOUNT_INITIAL_BALANCE, FACTORY_ACCOUNT, SECRETS_REPO_PATH } from './constants';
...
export const loadAccount = async (accountName: string = FACTORY_ACCOUNT): Promise<Account> => {
  ...
  if (version && version.payload && version.payload.data) {
    ...
    await keyStore.setKey(TESTNET_NEAR_CONFIG.networkId, accountName, KeyPair.fromString(gcpPK));
